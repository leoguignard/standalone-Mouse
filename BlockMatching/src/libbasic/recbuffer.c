                     ...
                     filterType filterType )
{
   ...
   */
  auxBuf = (float*)vtmalloc( sizeAuxBuf * sizeof(float), "auxBuf", proc );
  if ( auxBuf == NULL ) {
    if ( _verbose_ > 0 )
                   ...
                   filterType filterType )
{
  ...
  if ( typeOut == FLOAT ) {
    theXX = (float*)vtmalloc( dimxXdimy * sizeof( float ), "theXX", proc );
  } else {
    theXX = (float*)vtmalloc( 2 * dimxXdimy * sizeof( float ), "theXX", proc );
  }
                   ...
                   filterType filterType )
{
  ...
  if ( typeOut == FLOAT ) {
    theSL = (float*)vtmalloc( (1+bufferDims[2]) * dimxXdimy * sizeof( float ), "theSL", proc );
  } else {
    theSL = (float*)vtmalloc( (1+2*bufferDims[2]) * dimxXdimy * sizeof( float ), "theSL", proc );
  }
                   ...
                   filterType filterType )
{
  ...
  if ( typeOut == FLOAT ) {
    theXX = (float*)vtmalloc( 4 * dimxXdimy * sizeof( float ), "theXX", proc );
  } else {
    theXX = (float*)vtmalloc( 5 * dimxXdimy * sizeof( float ), "theXX", proc );
  }
                   ...
                   filterType filterType )
{
  ...
  if ( typeOut == FLOAT ) {
    theX  = (float*)vtmalloc( (7+3*bufferDims[2]) * dimxXdimy * sizeof( float ), "theX", proc );
  } else {
    theX = (float*)vtmalloc( (7+4*bufferDims[2]) * dimxXdimy * sizeof( float ), "theX", proc );
  }
                             ...
                             filterType filterType )
{
  ...
  if ( (typeOut == FLOAT) || (typeOut == DOUBLE) ) {
    ...
    bufferResult = (void*)vtmalloc( (dimx*dimy*dimz) * sizeof(r32), "bufferResult", proc );
   ...
   */
  theLine = (double*)vtmalloc( 3 * maxLengthline * sizeof(double), "theLine", proc );
